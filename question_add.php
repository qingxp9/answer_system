...
?>
    <!--页面名称-->
	<h3>题目添加/修改<a href="question_manager.php">返回>></a></h3>
    <!--表单开始-->
    <form action="?" method="post" name="class_add" id="class_add" enctype="multipart/form-data">
        <p>
            题目名称：<input type="text" size=50 value="<?php echo $question_value["question_subject"];?>" name="question_subject">
        </p>
        <p>
            题目选项：<textarea name="question_options" cols="40" rows="10"><?php echo $question_value["question_options"];?></textarea>
        </p>
        <p>
            标准答案：<input type="text" size=50  value="<?php echo $question_value["question_true"];?>" name="question_true">
        </p>
         <p>
             <!--隐藏参数，用来放置操作标示和修改的ID-->
